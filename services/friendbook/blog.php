			...
			<div class="in-center">
				<div class="in-center-wrap">
						<div class="in-center-head" style="margin: auto auto;width: 80%">
									<h1>Create a unique and beautiful blog</h1>
						</div>
						<div class="in-center-body">
									<div class="blog">
										<div class="blogType">
											<img width="145" src="<?php echo BASE_URL;?>assets/images/business.png"/>
										</div>
										<div class="blogTypeName">
											<h3>Business or brand</h3>
										</div>
										<div class="blogTypeDescription">
											<h5>Showcase your products and services, spotlight your brand and reach more customers on Friendbook.</h5>
										</div>
										<div class="blogCreateLink">
											<h5><a href="blogcreate.php">Create your blog</a></</h5>
										</div>
									</div>
									<div class="blog">
										<div class="blogType">
											<img width="145" src="<?php echo BASE_URL;?>assets/images/community.png"/>
										</div>
										<div class="blogTypeName">
											<h3>Community or public figure</h3>
										</div>
										<div class="blogTypeDescription">
											<h5>Connect and share with people in your community, organisation, team, group or club.</h5>
										</div>
										<div class="blogCreateLink">
											<h5><a href="blogcreate.php">Create your blog</a></</h5>
										</div>
									...
									<div class="blog">
										<div class="blogType">
											<img width="145" src="<?php echo BASE_URL;?>assets/images/personal.png"/>
										</div>
										<div class="blogTypeName">
											<h3>Personal</h3>
										</div>
										<div class="blogTypeDescription">
											<h5>The personal blog doesn’t focus on a specific topic or audience. Bloggers write about what interests them: their hobbies, beliefs, daily life, politics, sports, etc., and they attract the types of people that share the same interests.</h5>
										</div>
										<div class="blogCreateLink">
											<h5><a href="blogcreate.php">Create your blog</a></</h5>
										</div>
									...
									<div class="blog">
										<div class="blogType">
											<img width="145" src="<?php echo BASE_URL;?>assets/images/affiliate.png"/>
										</div>
										<div class="blogTypeName">
											<h3>Affiliate</h3>
										</div>
										<div class="blogTypeDescription">
											<h5>The content for this type of blog focuses on products. It’s usually in the form of product reviews or tutorials of using the products. The call to action is to purchase the product through the blog’s affiliate link.</h5>
										</div>
										<div class="blogCreateLink">
											<h5><a href="blogcreate.php">Create your blog</a></</h5>
										</div>
						...
						<div class="in-center-footer"></div>
                </div>
			</div>
			<div class="in-right">
