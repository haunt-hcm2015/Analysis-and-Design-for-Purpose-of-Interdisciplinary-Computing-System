<?php 
    ...
    if (isset($_POST['deleteMsg']) && !empty($_POST['deleteMsg'])){
        ...
        $getFromMessage->delete($messageID, $userID);
    }
    ...
    if (isset($_POST['showChatMessage']) && !empty($_POST['showChatMessage'])){
        ...
        $getFromMessage->getMessages($messageFrom, $userID);
        $getFromMessage->messageViewed($userID);
    }
    if (isset($_POST['showMessage']) && !empty($_POST['showMessage'])){
        $userID  = $_SESSION['user_id'];
        $messages = $getFromMessage->recentMessages($userID);
?>
                                ...
                                <div class="people-message" data-user="<?php echo $message->user_id;?>">
                                    <div class="people-inner">
                                        ...
                                        <div class="name-right2">
                                            <span><a href="<?php echo BASE_URL.$message->username;?>"><?php echo $message->screen_name;?></a></span><span>@<?php echo $message->username;?></span>
                                        </div>
                                        <span>
                ...
                <div class="message-send2">
                    ...
                    <div class="main-msg-footer">
                        <div class="main-msg-footer-inner">
                            <ul>
                                <li>
                                    <textarea id="msg" name="msg" placeholder="Write some thing!"></textarea>
                                </li>
                                <li>
                                    <input id="msg-upload" type="file" value="upload" />
                                    <label for="msg-upload"><i class="fa fa-camera" aria-hidden="true"></i></label>
                                </li>
                                <li>
                                    <input id="send" data-user="<?php echo $messageFrom;?>" type="submit" value="Send" />
                                </li>
                            </ul>
                        </div>
                    </div>
