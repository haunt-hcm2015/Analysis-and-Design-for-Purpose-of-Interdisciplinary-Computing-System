<?php 
   if (isset($_GET['username']) === true && empty($_GET['username']) === false){
        ...
        $profileData = $getFromUser->userData($userID);
...
<html>
   <head>
      <title>People following <?php echo $profileData->screen_name. ' (@'.$profileData->username.')';?></title>
      <meta charset="UTF-8" />
         ...
         <div class="in-full-wrap">
            ...
            <div class="wrapper-following">
               <div class="wrap-follow-inner">
                  <?php $getFromFollow->followingList($profileId, $userID, $profileData->user_id);?>
               </div>
            </div>
         </div>
      </div>
